...
struct pe_header
{
	...
	unsigned long long image_base; //PE_BASE
...
unsigned long long int spos;
int save_file,checksum_stage,checksum_word,checksum_carry;
unsigned long long int pe_checksum,pe_fsize;
void swrite(void *buf,unsigned long long int size)
{
...
unsigned long long size_align2(unsigned long long size)
{
	if(size==0)
	{
		return 0;
