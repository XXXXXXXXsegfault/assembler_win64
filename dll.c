...
char *name_seg;
unsigned long long name_seg_size;
struct function_tab
{
	char *dllname;
	unsigned long long dllname_addr;
	unsigned long long funname_ptr;
	unsigned long long num_funs;
	char **funname;
	unsigned long long *funname_addr;
	struct lines **l;
} *function_tab;
unsigned long long function_tab_size;
unsigned long long import_tab_off;
unsigned long long *function_addr_tab,function_addr_tab_size;
unsigned int size_imports;
unsigned long long size_align(unsigned long long size);
unsigned long long nametab_add(struct name_tab **tab,char *name)
{
